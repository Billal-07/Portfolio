        ...
        <div className={`${navBg} duration-700  flex justify-between ml-10 mr-10 rounded-b-2xl`}>
          <div className="flex items-center">
            <Image
              ...
              alt="logo"
            />
            <h1 className={`hidden sm:hover:${cardBg} duration-300 sm:hover:p-2 sm:hover:pr-4 sm:hover:pl-4 hover:rounded-xl hover:text-xl font-bold ml-4 sm:flex`}>BILAL <span className="hidden ml-2 sm:flex">HASHMI </span></h1>
          </div>
